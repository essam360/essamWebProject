...
define([
	...
	"ecm/Messages",
	"../../LoggerMixin"
], function(declare, lang, array, Desktop, Request, Messages, LoggerMixin) {

	/**
	 * @name ecm.model.admin.RedactionRolesData
	 * @class Represents the redaction admin roles configuration objects.
	 * @augments ecm.LoggerMixin
	 * @private
	 * @since 3.0
	 */
	var RedactionRolesData = declare("ecm.model.admin.RedactionRolesData", [
		LoggerMixin
	], {
		/** @lends ecm.model.admin.RedactionRolesData.prototype */
