...
template) {
	 ...
	 */
	return declare("ecm.widget.layout.EntryTemplateFlyoutPane", [
		_LaunchBarDialogPane
	], {
		/** @lends ecm.widget.layout.EntryTemplateFlyoutPane.prototype */
		...
		selectRepository: function(repository) {
			...
			this.selectContentPane("manageEntryTemplates", {
		...
		_getRepositoryStore: function(repository) {
			...
			for ( var i in repositories) {
				...
				if (repository && repository.entryTemplatesEnabled && repository.showInEntryTemplateView) {
