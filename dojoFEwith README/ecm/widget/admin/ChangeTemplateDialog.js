...
define([
	...
	/**
	 * @name docDojo.ChangeTemplateDialog
	 * @class Provides a dialog box that is used to author change a template for IBM Docs.
	 * @augments ecm.widget.dialog.AddContentItemDialog
	 */
	return declare("docDojo.ChangeTemplateDialog", [ CheckInDialog ], {
	/** @lends docDojo.ChangeTemplateDialog.prototype */
