...
function(declare, lang, registry, ScrollingTabController) {
	 ...
	 */
	return declare("ecm.widget.admin.RedactionTabController", [
		...
		onAddChild: function(/*dijit._Widget*/page, /*Integer?*/insertIndex) {
			...
			if (page instanceof ecm.widget.admin.TabRedactionReason || page instanceof ecm.widget.admin.TabRedactionRole || page instanceof ecm.widget.admin.TabRedactionPolicy){
				page.controlButton._setCloseButtonAttr(true);
			}
		}
	});
